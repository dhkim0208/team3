...
public class BookRentalController {
    ...
    @RequestMapping(
        value = "bookRentals/{id}/reserve",
        method = RequestMethod.PUT,
        produces = "application/json;charset=UTF-8"
    )
    public BookRental reserve(
        @PathVariable(value = "id") Long id,
        HttpServletRequest request,
        HttpServletResponse response
    ) throws Exception {
        System.out.println("##### /bookRental/reserve  called #####");
        Optional<BookRental> optionalBookRental = bookRentalRepository.findById(
            id
        );
    ...
    @RequestMapping(
        value = "bookRentals/{id}/cancel",
        method = RequestMethod.PUT,
        produces = "application/json;charset=UTF-8"
    )
    public BookRental cancel(
        @PathVariable(value = "id") Long id,
        HttpServletRequest request,
        HttpServletResponse response
    ) throws Exception {
